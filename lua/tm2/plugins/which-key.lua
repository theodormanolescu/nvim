...
function M.config()
  local mappings = {
    ...
    f = {
      ...
      g = { "<cmd>Telescope git_files<cr>", "Help" },
      H = { "<cmd>Telescope highlights<cr>", "Highlights" },
      l = { "<cmd>Telescope resume<cr>", "Last Search" },
      M = { "<cmd>Telescope man_pages<cr>", "Man Pages" },
      r = { "<cmd>Telescope oldfiles<cr>", "Recent File" },
      R = { "<cmd>Telescope lsp_document_symbols<cr>", "Symbols" },
    ...
    l = {
      ...
      f = { require("tm2.utils").format, "Format" },
    ...
    t = {
      name = "Tab",
      t = {
        "<cmd>lua require('telescope').extensions['telescope-tabs'].list_tabs(require('telescope.themes'))<cr>",
